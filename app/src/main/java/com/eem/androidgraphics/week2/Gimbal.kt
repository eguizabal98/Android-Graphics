...
class Gimbal(context: Context) : View(context) {
    ...
    init {
        ...
        val task = object : TimerTask() {
            ...
            override fun run() {
                ...
                drawCubeVertices = rotate(drawCubeVertices, (angle * (2 * PI) / 360),AxisRotation.X_AXI)
                drawCubeVertices = rotate(drawCubeVertices, (90 * (2 * PI) / 360),AxisRotation.Y_AXI)
                drawCubeVertices = rotate(drawCubeVertices, (25 * (2 * PI) / 360),AxisRotation.Z_AXI)
                drawCubeVertices = translate(drawCubeVertices, 200.0, 200.0, 0.0)
                this@Gimbal.invalidate()
                angle += 10
